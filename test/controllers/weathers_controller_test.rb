...
class WeathersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weather" do
    assert_difference("Weather.count") do
      post weathers_url, params: { weather: { city_id: @weather.city_id, datetime: @weather.datetime, description: @weather.description, temperature: @weather.temperature } }
    end
  ...
  test "should update weather" do
    patch weather_url(@weather), params: { weather: { city_id: @weather.city_id, datetime: @weather.datetime, description: @weather.description, temperature: @weather.temperature } }
